...
urlpatterns = [
    ...
    path('work-visa/', views.VisaListAPIView.as_view()),
    path('work-visa/<int:pk>/', views.VisaRetrieveAPIView.as_view()),
    path('intern-visa/', views.InternVisaListAPIView.as_view()),
    path('intern-visa/<int:pk>/', views.InternVisaRetrieveAPIView.as_view()),
